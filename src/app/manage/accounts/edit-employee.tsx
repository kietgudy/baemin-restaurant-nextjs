...
import { useGetAccountDetail, useUpdateAccountMutation } from '@/queries/useAccount'
...
export default function EditEmployee({
  ...
  const {data} = useGetAccountDetail({
    id: id as number,
    enabled: Boolean(id),
  })
  ...
  const onSubmit = async (values: UpdateEmployeeAccountBodyType) => {
    ...
    try {
      ...
      if (file) {
        ...
        const imageResult = await uploadMediaMutation.mutateAsync(formData);
        const imageUrl = imageResult.payload.data;
        body = {
          ...body,
          avatar: imageUrl,
        };
