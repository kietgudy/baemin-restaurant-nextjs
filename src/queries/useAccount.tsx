...
import { GetGuestListQueryParamsType, UpdateEmployeeAccountBody, UpdateEmployeeAccountBodyType } from "@/schemaValidations/account.schema";
...
export const useGetAccountDetail = ({ id, enabled }: { id: number, enabled: boolean }) => {
  return useQuery({
